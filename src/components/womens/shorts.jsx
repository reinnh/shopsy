...
export default function ProductGridShorts() {
  return (
    <section className="relative px-4 py-8 md:px-12 lg:px-20 bg-background text-foreground">
      <h2 className="text-3xl font-bold mb-8 text-center">Womens' Shorts </h2>

      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {womenShorts.map((product, index) => (
          <Link
              ...
              <CardContent className="p-4">
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="flex items-center text-yellow-500">
                    <Star className="w-4 h-4 fill-yellow-400 mr-1" /> 4.6
                  </span>
                </div>
